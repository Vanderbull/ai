...
# --- DATABAS HANTERING (UPPDATERAD V24) ---
class AgentDB:
    ...
    def _initialize_db(self):
        ...
        # --- NY ROBUST ÅTERSTÄLLNINGSLOGIK FÖR PLÅNBOK (V24) ---
        
        # Tvinga återställning: Radera gammalt saldo och sätt in nytt
        ...
        # Bekräftelse av status (alltid återställt)
...
# --- KÄRNFUNKTIONER (KÖPCYKEL - UPPDATERAD V24) ---

def analyze_and_upgrade_hardware_v24(db: AgentDB):
    ...
    print("\n--- 🤖 SystemAgent V24: Hårdvaruanalys & Prioriterad Uppgradering Startad ---")
...
if __name__ == "__main__":
    ...
    try:
        ...
        analyze_and_upgrade_hardware_v24(db)
