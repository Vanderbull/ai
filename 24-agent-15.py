...
def input_listener():
    ...
    while True:
        try:
            # Använd rå input för att undvika att blockera när man trycker Enter utan text
            # Återställa terminalprompten efter varje inmatning
...
def get_llm_response_from_history(user_query: str, history_path: str) -> str:
    ...
    try:
        ...
        # Använd de senaste 100 raderna för relevanssökning
    ...
    try:
        ...
        # Ta bort inledande bindestreck och mellanslag från matchningen
...
# --- KÄRNFUNKTIONER FÖR AGENTEN (Oförändrade) ---
# ... (alla befintliga funktioner som update_agent_state, get_sentiment_score, get_stock_price, etc.) ...
...
def get_recent_news(ticker_symbol: str) -> list:
    ...
    try:
        ...
        # print(f"FEL vid hämtning av nyheter: {e}")
        return []
...
def run_agent():
    ...
    # --- 1. Hämta nuvarande tillstånd och Uppdatera Version ---
    ...
    input_thread.start()
    print("📢 Interaktivt läge aktivt: Ställ frågor direkt i terminalen.")
    ...
    # Justerat intervall för Self-Talk: 1-5 minuter (60-300 sekunder)
